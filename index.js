...
app.get("/get-user/:useeid",(req,res)=>{

    mongoClient.connect(connectionString).then(connectionObject=>{
        var database = connectionObject.db("videodb");
        database.collection("tblusers").find({UserId:req.params.useeid}).toArray().then(documents=>{
            res.send(documents);
            res.end();
        });
    });
...
app.put("/edit-video/:id", (req, res)=>{
    ...
    mongoClient.connect(connectionString).then(connectionObject=>{
        ...
        database.collection("tblvideo").updateOne({VideoId:parseInt(req.params.id)},{$set:video}).then(()=>{
